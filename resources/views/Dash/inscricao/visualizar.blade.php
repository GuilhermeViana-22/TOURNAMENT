...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-7 py-12">
        ...
        <tbody>
            <tr class="hover:bg-gray-200 transition duration-300">
                ...
                <td class="py-2 px-4 border text-lg text-black">
                    {{ \Carbon\Carbon::parse($Register['created_at'])->format('d/m/Y H:i') }}</td>
                <td class="py-2 px-4 border text-lg text-black">
    ...
    <p class="mt-4 text-gray-700 text-lg">Aguardando a duo fazer a inscrição.</p>
</div>
    <!-- Modal -->
            ...
            <div class="inline-block w-full max-w-md p-6 my-8 bg-white rounded-lg shadow-lg">
                ...
                <div class="mt-4">
                    <button @click="open = false"
                        class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded">Fechar</button>
                </div>
            </div>
        </div>
    </div>
